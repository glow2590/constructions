...
<head runat="server">
    <title>El Dorado Concrete LLC</title>
     <meta charset="<u>content</u>tf-8">
  ...
  logo
          ...
          <div class="menu">
            <ul>
              ...
              <li> <a href="contact.html#contact-form">Contact us</a></li>
...
<div class="">
    ...
    <div class="login form-group">
      <form class="loginForm" style="display:block;">
        ...
        <input type="text" class="username form-control" name="username" placeholder="please enter your name" id="userName">
        <label for="passswor">password</label>
        <input type="password" class="password form-control" name="password"  placeholder="please enter your name" id="passWord">
        <small class="usrnmpw-error">
          please enter a vaild username and password
        </small><br/>
        <input type="submit" name="login" value="login" id="login">
              ...
              <div class="progress" style="width:25%;">
                <div class="progress-bar progress-bar-striped progress-bar-animated" style="width:20%; background-color:dimgray;"></div>
              </div>

              <select class="Status" name="Status">
                  <option  >working</option>
                  <option selected value="100%">done</option>
            </select>
            </div><!--content end-->

      <script type="text/javascript">

        console.log($(".Status").children(":selected").text());
      </script>
...
<div class="footer">
    ...
    <center> <div class="footer-header fa-2x">El Dorado Concrete LLC</div></center>
    <p class="fa fa-envelope-square ">Email: eldoradoconcretellc169@yahoo.com</p>
    <br />
    <p class="fa fa-mobile">Mobile: 720-434-8905 & 786-661-0977</p>
</div>
<!--<footer>-->
